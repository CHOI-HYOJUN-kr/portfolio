...
- **담당:** 자동·수동 시퀀스와 위치결정, HMI 6화면, 오류 표시와 작업 재개 기능을 구현했습니다.
...
Reset은 전체 상태를 초기화하고, Resume은 중단 당시의 상태를 유지한 채 작업을 재개하도록 구분했습니다. 중단 후에는 완료 수량과 다음 적재 위치를 보존했습니다. HMI 수동운전으로 장비와 공작물 상태를 점검·조정한 뒤 자동운전을 이어갔습니다.
